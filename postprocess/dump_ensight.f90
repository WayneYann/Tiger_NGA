...
!!$  end if
  ...
  if (combust) then
     ...
     if (trim(chemistry).eq.'finite chem') then
        ...
        name = "SRC_H2O"
        call dump_ensight_3D_scalar(chemsrc_gp(:,:,:,1),name)
        name = "SRC_CO"
        call dump_ensight_3D_scalar(chemsrc_gp(:,:,:,2),name)
        name = "SRC_CO2"
        call dump_ensight_3D_scalar(chemsrc_gp(:,:,:,3),name)
        name = "D_H2O"
        call dump_ensight_3D_scalar(diff_gp(:,:,:,1),name)
        name = "D_CO"
        call dump_ensight_3D_scalar(diff_gp(:,:,:,2),name)
        name = "D_CO2"
        call dump_ensight_3D_scalar(diff_gp(:,:,:,3),name)
     end if
