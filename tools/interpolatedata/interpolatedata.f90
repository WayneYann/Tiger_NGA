...
program interpolator
  ...
  ! SD
  integer :: mini,maxi,minj,maxj,walluj,walllj
  ! SD
  ...
  do var=1,nvar
     ...
     case default
        ...
        ! SD Hack this part to conserve mass after coflow interpolation 
!!$        ! Need to run init_flow and print out mask locations for both geometries
!!$        mini = 2!3  ! Index of the first non-wall point
!!$        maxi = 5  ! Furthest point that is to the left of the first non-wall point in data1
!!$        minj = 16 !26  ! Highest point that is to the downside before reaching the wall in data1
!!$        maxj = 23 !42  ! Lowest point that is to the upside of the wall in data1
!!$        walluj =  21 !37 ! Index of the upper wall cell
!!$        walllj =  18 !30 ! Index of the lower wall cell
!!$
!!$        do i=mini,maxi-1
!!$           data2(i,walllj-1:walluj+1,nz2) = data2(maxi,walllj-1:walluj+1,nz2) 
!!$        end do
!!$        do j=minj+1,walllj
!!$           data2(1:mini-1,j,nz2) = data2(1:mini-1,minj,nz2) 
!!$        end do
!!$        do j=walluj,maxj-1
!!$           data2(1:mini-1,j,nz2) = data2(1:mini-1,maxj,nz2) 
!!$        end do
        ! SD end
     end select
