...
subroutine rjacobi(n,a,b,ab)
  ...
  if (n.le.0 .or. a.le.-1.0_WP .or. b.le.-1.0_WP) call die('In rjacobi: parameters out of range.')
  
  ! Compute the polynomials
  nu = (b-a)/(a+b+2.0_WP)
  mu = 2.0_WP**(a+b+1.0_WP)*gamma(a+1.0_WP)*gamma(b+1.0_WP)/gamma(a+b+2.0_WP)
  if (n.eq.1) then
     ab(1,1) = nu
     ab(1,2) = mu
     return
